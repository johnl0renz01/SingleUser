...
public class Main {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
        ...
        jobsConsidered[anotherCounter] = 1;
				...
				System.out.println("Job " + (anotherCounter + 1) + " Memory failed to load. Insufficient memory space for allocation.");
			}
    ...
    do {
      ...
      jobsPrint++;
		...
		System.out.println("\n\nConclusion: There are only " + jobsAllocated + " jobs considered for memory allocation.");
	}
}